      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">{{ $about->judul ?? 'About Us' }}</h1>
					...
					<div class="col-md-5 order-md-last wrap-about align-items-stretch">
						<div class="wrap-about-border">
							@if(!empty($about->gambar))
								<div class="img" style="background-image: url({{ asset('storage/'.$about->gambar) }}); border"></div>
							@else
								<div class="img" style="background-image: url({{ asset('images/about.jpg') }}); border"></div>
							@endif
							<div class="text">
								<h3>{{ $about->deskripsi_singkat ?? 'Read Our Success Story for Inspiration' }}</h3>
								<p>{{ Str::limit($about->isi_konten ?? 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.', 150) }}</p>
								<p><a href="#" class="btn btn-primary py-3 px-4">Contact us</a></p>
							</div>
						</div>
					</div>
					<div class="col-md-7 wrap-about pr-md-4 ftco-animate">
          	<h2 class="mb-4">{{ $about->judul ?? 'Welcome to Consolution' }}</h2>
						<div>
							{!! nl2br(e($about->isi_konten ?? 'On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word.
