        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('adminui.about.testimonial') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('section_subtext') is-invalid @enderror" 
                                                  ...
                                                  required>{{ old('section_subtext') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div id="imagePreview" style="display: none; margin-top: 10px;">
                                            <img id="preview" src="" style="max-width: 100%; max-height: 150px; border-radius: 50%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
