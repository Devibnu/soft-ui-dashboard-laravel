                ...
                <div class="row gx-4">
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-bold text-sm">Kelola Hero Section, Konten, dan Testimoni - 3 Tab System</p>
                        </div>
                    </div>
                    <div class="col-auto ms-auto">
                        ...
                        <a href="{{ route('adminui.about-new') }}" class="btn btn-primary btn-sm">
                            <i class="ni ni-settings me-1"></i>New System
                        </a>
                    </div>
                </div>
            </div>
...
function saveTestimonials() {
    ...
    fetch('{{ route("adminui.about.testimonials.bulk-update") }}', {
        method: 'POST',
        body: formData,
        headers: {
