                                ...
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check p-3 rounded" style="background-color: #d4edda; border: 2px solid #28a745;">
                                                <input class="form-check-input" type="checkbox" name="is_published" id="published" value="1" checked onchange="togglePublishStatus(this)">
                                                <label class="form-check-label" for="published">
                                                    <i class="material-icons text-sm me-1" id="publish-icon" style="color: #28a745;">public</i>
                                                    <span id="publish-text" style="color: #28a745; font-weight: bold;">PUBLIKASIKAN KONTEN INI (tampilkan di website)</span>
                                                </label>
                                            </div>
                                            <small class="text-muted">
                                                <i class="material-icons text-sm">info</i>
                                                <span id="publish-help">✅ Konten akan ditampilkan di website publik dan dapat diakses pengunjung.</span>
                                            </small>
                                        </div>
...
function togglePublishStatus(checkbox) {
    ...
    if (checkbox.checked) {
        ...
        icon.className = 'material-icons text-sm me-1';
