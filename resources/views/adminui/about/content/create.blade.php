                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6>Tambah About Content Baru</h6>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('adminui.about.content') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('left_paragraph') is-invalid @enderror" 
                                                  ...
                                                  required>{{ old('left_paragraph') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('right_paragraph') is-invalid @enderror" 
                                                  ...
                                                  required>{{ old('right_paragraph') }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i> Simpan Content
                                        </button>
                                    </div>
                                </div>
                            </div>
