...
@section('title', 'Tambah Header Info')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>Tambah Header Info</h6>
                        <a href="{{ route('adminui.header-info.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Kembali
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('adminui.header-info.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <span class="ms-2" id="statusLabel">Aktif</span>
                                        <div>
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Simpan Header Info
                                </button>
                            </div>
                        </form>
                    </div>
