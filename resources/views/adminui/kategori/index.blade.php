                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-white text-capitalize ps-3">Kelola Kategori</h6>
                            </div>
                    ...
                    @if($kategoris->count() > 0)
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    ...
                                                    <span class="badge badge-sm bg-gradient-info mt-1">{{ $kategori->artikels()->count() }} artikel</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                        ...
                        @else
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-sm text-muted mb-3">Mulai buat kategori pertama untuk mengorganisir artikel blog Anda.</p>
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm mb-0">
                                        Kategori membantu pengunjung menemukan artikel yang relevan. Gunakan nama kategori yang jelas dan deskriptif. 
                ...
                <form id="formKategori">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" required placeholder="Contoh: Digital Marketing">
                        </div>
...
document.getElementById('formKategori').addEventListener('submit', function(e) {
    ...
    const url = isEditMode ? `/adminui/kategori/${kategoriId}` : '/adminui/kategori';
