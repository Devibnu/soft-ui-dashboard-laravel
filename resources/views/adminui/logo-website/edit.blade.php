        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6>Edit Logo Website</h6>
                    <a href="{{ route('adminui.logo-website.index') }}" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left me-1"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('adminui.logo-website.update', $logoWebsite) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Current Logo -->
                                @if($logoWebsite->gambar)
                                <div class="form-group mb-3">
                                    <label class="form-label">Logo Saat Ini</label>
                                    <div>
                                        <img src="{{ asset('storage/' . $logoWebsite->gambar) }}" 
                                             alt="Current Logo" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="status" name="status" value="1" {{ $logoWebsite->status ? 'checked' : '' }}>
                                        <span class="slider"></span>
                                    </label>
                                    <span class="ms-2 {{ $logoWebsite->status ? 'text-success' : 'text-danger' }}" id="statusLabel">{{ $logoWebsite->status ? 'Aktif' : 'Non-Aktif' }}</span>
                                    <div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="preview-container" id="previewContainer">
                                        @if($logoWebsite->gambar)
                                            <img src="{{ asset('storage/' . $logoWebsite->gambar) }}" alt="Preview">
                                        @else
