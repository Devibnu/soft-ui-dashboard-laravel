                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-white text-capitalize ps-3">Kelola Logo Website</h6>
                            </div>
                            <div class="col-auto pe-3">
                                <a href="{{ route('adminui.logo-website.create') }}" class="btn bg-gradient-dark mb-0">
                ...
                <div class="card-body px-0 pb-2">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ route('adminui.logo-website.edit', $logo) }}" 
                    ...
                    @else
                        <div class="text-center py-5 mx-4">
                            ...
                            <h5 class="text-secondary">Belum ada Logo Website</h5>
                            <p class="text-sm text-secondary">Silakan upload logo website untuk mulai mengelola branding Anda.</p>
                            <a href="{{ route('adminui.logo-website.create') }}" class="btn bg-gradient-primary mt-3">
...
function deleteLogo(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.action = '{{ route("adminui.logo-website.index") }}/' + id;
            form.submit();
        }
    });
}
