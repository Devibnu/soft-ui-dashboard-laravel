        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            ...
            <ul class="navbar-nav justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a href="{{ route('adminui.profile') }}" class="nav-link text-body font-weight-bold px-0 me-3">
                        <i class="fa fa-user me-sm-1"></i>
                        <span class="d-sm-inline d-none">{{ Auth::user()->name ?? 'Admin' }}</span>
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center">
                    <form method="POST" action="{{ route('adminui.logout') }}" class="d-inline">
                        @csrf
                        <a href="#" class="nav-link text-body font-weight-bold px-0" onclick="event.preventDefault(); this.closest('form').submit();">
