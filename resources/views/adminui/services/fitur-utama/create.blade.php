...
@section('title', 'Tambah Fitur Utama')
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <h6 class="mb-0">Tambah Fitur Utama</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control @error('judul_fitur') is-invalid @enderror" 
                                       id="judul_fitur" name="judul_fitur" value="{{ old('judul_fitur') }}" required>
                                @error('judul_fitur')
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi_fitur') is-invalid @enderror" 
                                          id="deskripsi_fitur" name="deskripsi_fitur" rows="4" required>{{ old('deskripsi_fitur') }}</textarea>
                            ...
                            <div class="col-md-12 mb-3" id="imagePreview" style="display: none;">
                                <label class="form-label">Preview Ikon</label>
                                <div>
