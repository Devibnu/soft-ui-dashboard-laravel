        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('adminui.projects.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="deskripsi_singkat" name="deskripsi_singkat" 
                                          rows="3" required>{{ old('deskripsi_singkat') }}</textarea>
                                <small class="text-muted">Deskripsi singkat untuk tampilan card/list</small>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="deskripsi_lengkap" name="deskripsi_lengkap" 
                                          rows="10">{{ old('deskripsi_lengkap') }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" class="form-control" id="gambar_utama" name="gambar_utama" 
                                       accept="image/*" required onchange="previewMainImage(event)">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="galeri" class="form-label">Galeri Gambar <span class="badge badge-info">Multiple Upload</span></label>
                                <input type="file" class="form-control" id="galeri" name="galeri[]" 
                                       accept="image/*" multiple onchange="previewGallery(event)">
                                <small class="text-muted d-block mt-1">
                                    <i class="fas fa-info-circle"></i> Tekan Ctrl/Cmd saat memilih file untuk upload multiple gambar sekaligus
                                </small>
...
$(document).ready(function() {
    ...
    function previewGallery(event) {
        ...
        if (files.length > 0) {
            ...
            countInfo.innerHTML = `<div class="alert alert-success py-2 mb-0"><i class="fas fa-check-circle"></i> ${files.length} gambar terpilih</div>`;
