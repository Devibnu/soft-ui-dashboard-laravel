        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="text-white text-capitalize ps-3 mb-0">Edit Header Projects</h6>
                                <p class="text-white text-xs ps-3 mb-0">Edit judul dan deskripsi section projects</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body px-4 pb-2">
                    ...
                    <form action="{{ route('adminui.projects.header.update', $headerProjects->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="judul_section" name="judul_section" 
                                       value="{{ old('judul_section', $headerProjects->judul_section) }}" required>
                                @error('judul_section')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" id="deskripsi_section" name="deskripsi_section" rows="4">{{ old('deskripsi_section', $headerProjects->deskripsi_section) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="status_aktif" name="status_aktif" {{ old('status_aktif', $headerProjects->status_aktif) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <div class="card border mt-3">
                                    ...
                                    <div class="card-body text-center py-4">
                                        <h2 class="mb-3" id="preview-judul" style="color: #344767;">{{ $headerProjects->judul_section }}</h2>
                                        <p class="text-muted mb-0" id="preview-deskripsi">{{ $headerProjects->deskripsi_section }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
